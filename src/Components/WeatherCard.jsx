...
function WeatherCard({ weather }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            await fetch(`${import.meta.env.VITE_API_URL}/weather/?lat=${lat}&lon=${long}&units=metric&APPID=${import.meta.env.VITE_API_KEY}`).then(res => res.json())
                .then(result => {
                    setData(result)
                    console.log(result);
                })
                ...
                <div className="card">
                    ...
                    <div className="minmaxContainer">
                        <div className="min">
                            ...
                            <p className="minTemp">{data.main?.temp_min}°</p>
                        </div>
                        <div className="max">
                            <p className="maxHeading">Max</p>
                            <p className="maxTemp">{data.main?.temp_max}°</p>
                        </div>
                    </div>
                </div>
            </div>
